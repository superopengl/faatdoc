...
export class CreateAgents1598515321928 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`INSERT INTO public."user" (id, email, secret, salt, role, status) VALUES ('87145c51-1ff9-4150-8268-3bf0b5914b71', 'jzhou@auao.com.au', 'd17ded725a5199e93deb94c425ff92f7856376a09bb3d8afa3e69c17f32c6ac9', 'cdb60793-002f-4afa-b91a-c03ff22b621a', 'admin', 'enabled')`);

...
const PrivacyPolicyPage = () => (
  <ContainerStyled>
    ...
    <Title style={{ textAlign: 'center' }}>AUA Allied Pty Ltd - Privacy Policy</Title>
    <p>Protecting your privacy and the confidentiality of your personal information is a high priority for AUA Allied Pty Ltd.</p>
    <p>Personal information with regards to this website and all AUA Allied Pty Ltd online portals (and any other AUA Allied Pty Ltd printed materials) means information we hold about you from which we can search for and retrieve your identity. For example, we may collect and use your name and address details when you acquire or use particular AUA Allied Pty Ltd membership services. AUA Allied Pty Ltd understands that providing your personal information imposes a serious responsibility upon us.</p>
    ...
    <p>We collect personal information directly from you, and only to the extent necessary to deliver and ensure a AUA Allied Pty Ltd membership service. We may choose to collect personal information from you when you fill in an application form, both in hard copy format or online via our website, or over the telephone.</p>
    ...
    <p>If we do not collect this information, we may not be able to provide you with the AUA Allied Pty Ltd membership service you have requested.</p>
    ...
    <p>AUA Allied Pty Ltd will collect your personal information in order to provide you with, or give you access to, a particular AUA Allied Pty Ltd membership service. AUA Allied Pty Ltd may choose to disclose your personal information for the main purpose for which we collect it, with such disclosure reasonably expected by you. Some of these examples include, but are not limited to:</p>
    <ul>
      <li>Helping AUA Allied Pty Ltd to develop a stronger relationship with you</li>
      <li>Internal membership management, accounting and finance</li>
      <li>Administrative reporting</li>
      <li>Protecting you and AUA Allied Pty Ltd from fraud</li>
      <li>As part of a AUA Allied Pty Ltd campaign.</li>
    </ul>
    <p>Occasionally, we may also disclose your personal information for the purposes of facilitating the distribution of marketing materials to you by AUA Allied Pty Ltd employing a third party. We will not do this if you ask us not to do so. There are other situations where we are compelled by law to disclose your personal information.</p>
    <Divider/>
    <Title level={2} id="direct-marketing">Direct Marketing</Title>
    <p>AUA Allied Pty Ltd may use the personal information we collect from you to identify particular AUA Allied
    ...
    shows and entertainment from AUA Allied Pty Ltd, our community partners or affiliated sponsors. We may
    then contact you to let you know about these products and services. If you do not wish to receive this direct
marketing information from AUA Allied Pty Ltd, please let us know.</p>
    <Divider/>
    ...
    AUA Allied Pty Ltd will take reasonable steps to ensure the personal information we collect, use and disclose is
...
incomplete or out-of-date, please contact us immediately and we will take reasonable steps to correct it.</p>
    <Divider/>
    <Title level={2} id="aua-allied-pty-ltd-campaigns">AUA Allied Pty Ltd Campaigns</Title>
    <p>AUA Allied Pty Ltd conducts various campaigns and from time to time may use your contact details to update
    you on the status of a campaign. Likewise, AUA Allied Pty Ltd may also use your details for specific petitions
    on campaigns. If you have signed a petition, your details may be used for instances such as presenting this
    information to members of Parliament. If you do not wish for AUA Allied Pty Ltd to contact you via phone or
email during or campaign or present a petition you have signed, please let us know.</p>
    ...
    <p>AUA Allied Pty Ltd takes reasonable steps to protect your personal information from loss, misuse, unauthorised
disclosure or destruction.</p>
    <Divider/>
    <Title level={2} id="cookies-on-aua-allied-pty-ltd-website">Cookies on AUA Allied Pty Ltd website</Title>
    <p>A "cookie" is a packet of information that allows the AUA Allied Pty Ltd server (the computer that houses our
...
sent. Please refer to your Internet browser's instructions or help screens to learn more about these functions.</p>
    <Divider/>
    <Title level={2} id="information-logged-on-the-aua-allied-pty-ltd-website">Information logged on the AUA Allied Pty Ltd website</Title>
    <p>When you visit the AUA Allied Pty Ltd web site, our server logs the following information which is provided by your browser for statistical purposes only:</p>
    <ul>
    ...
    <p>AUA Allied Pty Ltd will, upon your request, and subject to applicable privacy laws, provide you with access to your personal information held by us. However, we ask that you identify, as clearly as possible, the type/s of information requested.</p>
    <Divider/>
    <Title level={2} id="contact-the-aua-allied-pty-ltd-privacy-officer">Contact the AUA Allied Pty Ltd Privacy Officer</Title>
    <p>Please email your query and contact details (your name, contact phone number and email address) to the AUA Allied Pty Ltd Officer at <a href="mailto:office.aua.allied@gmail.com">office.aua.allied@gmail.com</a>. We will respond to your query or complaint within 14 working days from the date first lodged. If your complaint is not resolved to your satisfaction you can contact the Office of the Privacy Commissioner on <a href="tel:1300 363 992">1300 363 992</a>.</p>

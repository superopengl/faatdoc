...
const DisclaimerPage = () => (
  <ContainerStyled>
    ...
    <Title style={{ textAlign: 'center' }}>AU Accounting Office Pty Ltd - Disclaimer</Title>
...
incomplete or out-of-date, please contact us immediately and we will take reasonable steps to correct it.</p>
    <Divider/>
    <Title level={2} id="aua-allied-pty-ltd-campaigns">AU Accounting Office Pty Ltd Campaigns</Title>
...
disclosure or destruction.</p>
    <Divider/>
    <Title level={2} id="cookies-on-aua-allied-pty-ltd-website">Cookies on AU Accounting Office Pty Ltd website</Title>
...
sent. Please refer to your Internet browser's instructions or help screens to learn more about these functions.</p>
    <Divider/>
    <Title level={2} id="information-logged-on-the-aua-allied-pty-ltd-website">Information logged on the AU Accounting Office Pty Ltd website</Title>
    ...
    <Divider/>
    <Title level={2} id="searching-within-the-aua-allied-pty-ltd-website">Searching within the AU Accounting Office Pty Ltd website</Title>
    ...
    <Divider/>
    <Title level={2} id="contact-the-aua-allied-pty-ltd-privacy-officer">Contact the AU Accounting Office Pty Ltd Privacy Officer</Title>
    <p>Please email your query and contact details (your name, contact phone number and email address) to the AU Accounting Office Pty Ltd Officer at <a href="mailto:office.aua.allied@gmail.com">office.aua.allied@gmail.com</a>. We will respond to your query or complaint within 14 working days from the date first lodged. If your complaint is not resolved to your satisfaction you can contact the Office of the Privacy Commissioner on <a href="tel:1300 363 992">1300 363 992</a>.</p>

      ...
      <MediaQuery minDeviceWidth={801}>
        <MenuContianer>
          <Menu
            ...
            {(isAdmin && isAgent) && <Menu.Item key="notification"><Link to="/notification"><Badge count={notifyCount} showZero={false} offset={[10, 0]}>Notification</Badge></Link></Menu.Item>}
      ...
      <MediaQuery maxDeviceWidth={800}>
        ...
        >
          ...
          >
            ...
            {(isAdmin && isAgent) && <Menu.Item key="notification"><BellOutlined /> <Link to="/notification">Notification <Badge count={notifyCount} showZero={false} /></Link></Menu.Item>}
